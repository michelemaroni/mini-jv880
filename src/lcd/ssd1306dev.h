...
//
#ifndef _display_ssd1306dev_h
#define _display_ssd1306dev_h

#include <circle/device.h>
#include <circle/i2cmaster.h>
#include <circle/spinlock.h>
#include <circle/types.h>
#include <circle/addon/display/chardevice.h>

// Hard-codes how the text maps to the graphics display
#define SSD1306_COLUMNS	24	// 128/5 ~= 25
#define SSD1306_ROWS	2	// 32/8   = 4; But code uses Double Height Font

class CSSD1306Dev : public CCharDevice	/// LCD dot-matrix display driver (using SSD1306 controller)
{
public:
	...
	CSSD1306Dev (unsigned nWidth, unsigned nHeight,
